...
ggsave("fig_K_spread.eps", plot= fig_K_spread, dpi=1200, width = 17.4, height = 22, units = "cm", device = "eps")
```
...
ggsave("fig_roc.pdf", plot= cpk_roc, dpi=1200, width = 17.4, height = 11, units = "cm", device = "pdf")

ggsave("fig_roc.eps", plot= cpk_roc, dpi=1200, width = 17.4, height = 11, units = "cm", device = "eps")
```
...
ggsave("fig_roc_highAD.eps", plot= cpk_roc, dpi=1200, width = 17.4, height = 11, units = "cm", device = "eps")
```
