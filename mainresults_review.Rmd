...
ggsave("Figure2.png", plot = fig_cutpoint_deaged_alt, width = 9, height = 22, units = "cm", device = "png")
...
ggsave("Figure3.png",fig3s_Alt, width = 9, height = 18, units = "cm", device = "png")
