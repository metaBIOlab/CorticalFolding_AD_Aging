...
ggsave("fig1_alt_2.pdf", plot = fig1_alt_2, width = 9, height = 11.37, units = "cm", device = "pdf")
ggsave("fig1_alt_2.eps", plot = fig1_alt_2, width = 9, height = 11.37, units = "cm", device = "eps")
ggsave("fig1_alt_2.jpg", plot = fig1_alt_2, width = 9, height = 11.37, units = "cm", device = "jpg")
...
```{r}
#fit ANCOVA model
ancova_model <- aov(K ~ Age + Gender, data = filter(dados_hemi_v1, Diagnostic == "CTL"))

#view summary of model
Anova(ancova_model, type="III")

ggplot(data = dados_hemi_v1, aes(Age, K, color = Gender, fill = Gender, alpha = 0.4)) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_pubr() +
   stat_cor() + 
...
ggplot(data = dados_hemi_v1, aes(Diagnostic, K_age_decay, color = Gender, fill = Gender, alpha = 0.4)) +
  geom_boxplot() +
  theme_pubr() +
    guides(alpha = "none", color = "none", fill = "none") + 
  scale_fill_manual(values=cbbPalette2) +
...
```{r}
#fit ANCOVA model
ancova_model <- aov(K ~ Age + ESC, data = filter(dados_hemi_v1, Diagnostic == "CTL"))

#view summary of model
Anova(ancova_model, type="III")

ggplot(data = dados_hemi_v1, aes(ESC, K, color = Diagnostic, fill = Diagnostic, alpha = 0.4)) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_pubr() +
   stat_cor() + 
...
ggplot(data = dados_hemi_v1, aes(ESC, K_age_decay, color = Diagnostic, fill = Diagnostic, alpha = 0.4)) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_pubr() +
   stat_cor() + 
...
```{r}
#fit ANCOVA model
ancova_model <- aov(S ~ Age + Gender, data = filter(dados_hemi_v1, Diagnostic == "CTL"))
...
```{r}
#fit ANCOVA model
ancova_model <- aov(S ~ Age + ESC, data = filter(dados_hemi_v1, Diagnostic == "CTL"))
...
```{r}
#fit ANCOVA model
ancova_model <- aov(I ~ Age + Gender, data = filter(dados_hemi_v1, Diagnostic == "CTL"))
...
```{r}
#fit ANCOVA model
ancova_model <- aov(I ~ Age + ESC, data = filter(dados_hemi_v1, Diagnostic == "CTL"))
...
```{r}
fig_cutpoint_deaged_alt <- ggarrange(cutpoint_a, cutpoint_a_deaged, cutpoint_b, cutpoint_b_deaged, labels = c("A", "B", "C", "D"),  ncol = 1, nrow = 4, font.label = list(size = 11), common.legend = TRUE, legend = "bottom")

ggsave("fig_cutpoint_deaged_alt.pdf", plot = fig_cutpoint_deaged_alt, width = 9, height = 22, units = "cm", device = "pdf")
ggsave("fig_cutpoint_deaged_alt.eps", plot = fig_cutpoint_deaged_alt, width = 9, height = 22, units = "cm", device = "eps")
ggsave("fig_cutpoint_deaged_alt.jpg", plot = fig_cutpoint_deaged_alt, width = 9, height = 22, units = "cm", device = "jpg")
...
ggsave("fig3s.eps",fig3s, width = 9, height = 17.1, units = "cm", device = "eps")
...
```{r}
fig3s_Alt <- ggarrange(fig3b_Alt, fig3d_Alt, labels = c("A", "B"),ncol = 1, nrow=2, font.label = list(size = 11), common.legend = TRUE, legend = "bottom")

fig3s_Alt

#fig3s <- ggarrange(fig3a, fig3b,fig3c, fig3d, labels = c("A", "B","C","D"), nrow=2, ncol=2, font.label = list(size = 11))

ggsave("fig3s_Alt.pdf",fig3s_Alt, width = 9, height = 18, units = "cm", device = "pdf")
ggsave("fig3s_Alt.eps",fig3s_Alt, width = 9, height = 18, units = "cm", device = "eps")
ggsave("fig3s_Alt.jpg",fig3s_Alt, width = 9, height = 18, units = "cm", device = "jpg")
# ggsave("fig3s.pdf",fig3s, dpi = 1200, width = 18, height = 17.1, units = "cm", device = "pdf")
```
...
ggsave("fig3s_Alt_allgroups.pdf",fig3s_Alt_allgroups, width = 18, height = 9, units = "cm", device = "pdf")
ggsave("fig3s_Alt_allgroups.jpg",fig3s_Alt_allgroups, width = 18, height = 9, units = "cm", device = "jpg")
```
