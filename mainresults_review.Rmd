...
ggsave("fig3s_Alt.pdf",fig3s_Alt, width = 18, height = 9, units = "cm", device = "pdf")
ggsave("fig3s_Alt.png",fig3s_Alt, width = 18, height = 9, units = "cm", device = "png")
ggsave("fig3s_Alt.jpg",fig3s_Alt, width = 18, height = 9, units = "cm", device = "jpg")
# ggsave("fig3s.pdf",fig3s, dpi = 1200, width = 18, height = 17.1, units = "cm", device = "pdf")
```
